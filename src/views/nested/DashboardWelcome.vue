...
<template>
  <div class="welcome-message">
    <div class="wrapper">
      <div class="top-bar">
        <h2>Welcome to mvBank Early Test! 🏦</h2>
        <button
          v-wave="{
            duration: 0.2,
            color: 'currentColor',
      ...
      <div class="body welcome">
        ...
        <p>
          ...
          <span class="acc">{{ userStore.user?.formatted_account_number }}</span> that you will use
          to log in to the application and, of course, to accept payments from other Citizens using
          mvBank
        </p>
        <p>
        ...
        <p>
          Please share any feedback or features you'd like to see added, or just anything you found
          interesting, with me on Discord or Twitter! ✨
        </p>
        <caption>
          - Maeve
        </caption>
